...
export class KnowledgeBase {
  ...
  async add_document(document: Document): Promise<string> {
  ...
  private chunk_text(text: string, document_id: string): Chunk[] {
    const chunks: Chunk[] = [];
  ...
  private calculate_similarity(query: string, text: string): number {
  ...
  private extract_highlight(text: string, query: string): string {
